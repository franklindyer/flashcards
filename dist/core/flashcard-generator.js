    ...
    async runOnce(s, setState, callback) {
        ...
        var inputCallback = async (attempt) => {
            ...
            if (correct) {
                ...
                (0, logging_1.logPost)(thisDeckSlug, this.reportableData(s, cardData, firstAttempt, result));
        ...
        inputBox.onkeydown = async (e) => {
            if (e.key == "Enter") {
                ...
                (0, logging_1.logPost)(thisDeckSlug, this.reportableData(s, cardData, firstAttempt, FlashcardResult.Correct));
