...
exports.updateDeckFromRemote = updateDeckFromRemote;
...
function saveDeck(deckSlug, callback) {
    exports.gDeckRegistry[deckSlug].lastSaved = new Date();
    if (exports.gDeckRegistry[deckSlug].doSync) {
        (0, synchronization_1.syncUploadDeck)(exports.gDeckRegistry[deckSlug]);
    }
...
function menuSetup(deckSlug) {
    ...
    editBtn.onclick = () => {
        ...
        editorCont.replaceChildren(editor);
...
function updateDeckFromRemote(deckSlug, resolve) {
    if (exports.gDeckRegistry[deckSlug].doSync) {
        (0, synchronization_1.syncDownloadDeck)(deckSlug, new Date(exports.gDeckRegistry[deckSlug].lastSaved), (deckStr, resolve2) => {
...
function runDeck(deckSlug, forceSync = false) {
    var getState = () => exports.gDeckRegistry[deckSlug].state;
    var setState = (s) => {
        exports.gDeckRegistry[deckSlug].state = s;
    };
    updateDeckFromRemote(deckSlug, () => {
