...
exports.setDeepKey = setDeepKey;
exports.makeSubber = makeSubber;
exports.hideDetails = hideDetails;
exports.querySelectorTopLevel = querySelectorTopLevel;
...
function recursiveRepairJSON(obj, defaultObj, omitKeys = [], doPruning = true) {
...
function getDeepKey(objDict, keys) {
    if (keys.length == 0) {
        return objDict;
    }
...
function setDeepKey(objDict, keys, value) {
    if (keys.length == 0) {
        return objDict;
    }
    else if (keys.length == 1) {
...
function querySelectorTopLevel(el, query) {
